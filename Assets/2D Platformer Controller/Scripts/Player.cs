...
public class Player : MonoBehaviour
{
	...
	void fire()
	{
		...
		bulletPos = new Vector3(transform.position.x, transform.position.y+1, transform.position.z);
		...
		if (facingRight)
		{
			...
			music.Play ();
			//AudioSource.PlayClipAtPoint (so_arma, transform.position);
